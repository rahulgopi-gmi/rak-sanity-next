        ...
        onSubmit: async (values, { resetForm, setSubmitting }) => {
            try{
                const normalizePhone = (phone:string, countryCode:string) => {
                    ...
                    const codeOnly = countryCode.replace(/\D/g, "");                  
                    const phoneWithoutCode = digitsOnly.startsWith(codeOnly)
                        ? digitsOnly.slice(codeOnly.length)
                        : digitsOnly;
        ...
        <div id="contact" className="contact-wrapper">
            <div className={formonly ? "container mx-auto" : ""} >
                <div className="row flex -mx-2 max-lg:flex-col">
                    {
                        formonly &&
                            <div className="w-full px-2 [@media(max-width:991px)]:text-center [@media(max-width:991px)]:pb-[18px]">                                
                                <PillTag className="mb-7.5 max-lg:mx-auto px-4" variant={'light'}>Get Started</PillTag>
                                ...
                                <h5 className="text-black mb-4 font-sans text-base! not-italic font-normal leading-[normal]">
                                    GIVE US A CALL
                                </h5>

                                <Link href="tel:+97172222325"
                                    className="text-black text-21 mt-2 not-italic font-semibold leading-[100%] underline relative hover:text-[#5752A3] font-sans">
                                    +971 7 2222325
                                </Link>
                            </div>
                    }                    

                    <div className="w-full px-2 [@media(max-width:991px)]:w-full">
                        <form 
